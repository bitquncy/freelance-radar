...
Дополнительно к запуску: пробный период 7 дней без карты, скидка ~20% при годовой
оплате, реферальная программа (месяц бесплатно за приглашённого платящего
пользователя). Оплата — Telegram Payments как основной канал (подписка без выхода
из мессенджера), на сайте — резервный чек-аут через ЮKassa/CloudPayments.
